import { digitalMarketingText } from "@/data/digitalMarketingMain";
...
const { title, pagedesc, imagearrow } = digitalMarketingText;
...
export default DigitalMarketingText;
