const exploreTheCoursesData = {
  ...
  softwareEngineering: {
    smallHeading: "Explore the World of Software Engineering with Us!",
    bigHeading: "Let’s Dive More Into Software Engineering",
    sideHeadings: [
      { text: "Course Overview", contentId: "content1" },
    ...
    sideContents: {
      content1: {
        ...
        contentImg: "/assets/images/HomeNew/DM-CourceImg.png",
        contentText:
          "Digital Regenesys’ softwareEngineering Course is designed to provide a comprehensive understanding of the digital landscape. Learn the latest strategies for online marketing, social media, and analytics.",
        contentCard: [
          {
            icon: "/assets/images/HomeNew/Live Call.svg",
            text: "Live Classes",
