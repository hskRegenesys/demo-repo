const TalentedComponentData = {
  ...
  facultyCard: [
    ...
    {
      facultyImg: "/assets/images/HomeNew/faculty-img/Samidha_Photo.webp",
      facultyName: "Samidha Kurle",
      courseName: "Senior Lecturer",
      yearsOfExperience: "5 years",
    },
    {
      facultyImg: "/assets/images/HomeNew/faculty-img/bhupendra_mishra.webp",
    ...
    {
      facultyImg: "/assets/images/HomeNew/faculty-img/James_forson.webp",
...
export default TalentedComponentData;
