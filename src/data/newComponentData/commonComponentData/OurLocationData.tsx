const OurLocationData = {
  ...
  countryImage: "/assets/images/allImages/World-Map.png",
  locationPinImage: "/assets/images/allImages/Location-Pin.svg",
  USA: {
    countryName: "USA",
    countryFlagImg: "/assets/images/allImages/usa.svg",
  ...
  Kenya: {
    countryName: "Kenya",
    countryFlagImg: "/assets/images/allImages/ky.svg",
  ...
  Nigeria: {
    countryName: "Nigeria",
    countryFlagImg: "/assets/images/allImages/ni.svg",
  ...
  Tanzania: {
    ...
    countryFlagImg: "/assets/images/allImages/ta.svg",
