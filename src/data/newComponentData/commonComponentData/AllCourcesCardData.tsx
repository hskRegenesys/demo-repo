  ...
  Courses: {
    ...
    ProductManagement: {
      parentCource: {
        ...
        cardImg: "Images/Course-Card/PDM-card.webp",
    ...
    ManagementAdvancement: {
      parentCource: {
        ...
        cardImg: "Images/Course-Card/MA-card.webp",
    ...
    DataAndBusinessAnalytics: {
      parentCource: {
        ...
        cardImg: "Images/Course-Card/DBA-card.webp",
    ...
    DataScience: {
      parentCource: {
        ...
        cardImg: "Images/Course-Card/DS-card.webp",
    ...
    CyberSecurity: {
      parentCource: {
        ...
        cardImg: "Images/Course-Card/CS-card.webp",
    ...
    ProjectManagement: {
      parentCource: {
        ...
        cardImg: "Images/Course-Card/PM-card.webp",
    ...
    DigitalMarketing: {
      parentCource: {
        ...
        cardImg: "Images/Course-Card/DM-card.webp",
    ...
    DesignThinking: {
      parentCource: {
        ...
        cardImg: "Images/Course-Card/DT-card.webp",
