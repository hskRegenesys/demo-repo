const careersTransformedData = {
  ...
  "four-card": {
    ...
    card2: {
      rating: 4.7,
      ratingImg: "/assets/images/new-component-assets/rating-star.webp",
      text: "Customer Rating",
    },
    card3: {
      rating: 4.7,
      ratingImg: "/assets/images/new-component-assets/rise.webp",
      text: "Customer Rating",
    },
    card4: {
      percentage: "57%",
  ...
  swiperCardContainer: [
    {
      ...
      companyFirstRoleImg: "/assets/images/new-component-assets/google.webp",
      companySecondRoleImg: "/assets/images/new-component-assets/hcl.webp",
      StudentVidio:
    ...
    // {
    //   playImg: "/assets/images/new-component-assets/Polygon.svg",
    //   profileImg: "/assets/images/new-component-assets/students/Testimonial-5.webp",
    //   name: "Akshay Patil",
    //   role: "Machine Learning",
    //   experienceText:
    //     "After completing my course in Machine Learning, I registered myself for Data Science that was taught by Dr. Laika and I have to say both my instructors were very helpful and went beyond their ways to teach me. They also helped me create a professional LinkedIn profile. I am glad that I chose Digital Regenesys for my learning courses.",
